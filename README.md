...
class MyApp {
    ...
    public static void main() {
        ...
        Transaction transaction1 = new SimpleTransaction(
                ...
                "EUR",                      // Currency code
                "Transfer reference",       // End to end identifier
                "Optional identifier");     // Transaction identifier (optional)
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:pain.001.001.03">
    <CstmrCdtTrfInitn>
        <GrpHdr>
            <MsgId>PSSTFRPP0020210103070733</MsgId>
            <CreDtTm>2021-01-03T19:07:33.6166572</CreDtTm>
            <NbOfTxs>2</NbOfTxs>
        ...
        <PmtInf>
            <PmtInfId>20210103070733</PmtInfId>
            <PmtMtd>TRF</PmtMtd>
