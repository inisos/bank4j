...
import static io.inisos.bank4j.CustomerCreditTransferInitiationVersion.V12;

/**
 * @author Patrice Blanchardie
 */
class CreditTransferV12Test {
    ...
    void test_with_all_fields() {
        ...
        CreditTransferOperation creditTransfer = Bank.jaxbCreditTransferSepa(V12)
    ...
    void test_with_account_other_id() {
        ...
        CreditTransferOperation jaxbCreditTransfer = Bank.jaxbCreditTransferSepa(V12)
                .debtor(debtor)
                .debtorAccount(debtorAccount)
    ...
    private void assertValid(String xml) {
        Assertions.assertDoesNotThrow(() -> SchemaValidator.validateCreditTransfer(V12, new StringReader(xml)));
    }
}
