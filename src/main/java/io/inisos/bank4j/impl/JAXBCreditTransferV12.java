...
import iso._20022.pain_001_001_12.*;
...
/**
 * A JAXB ISO 20022 Credit Transfer with PAIN.001.001.12
 *
 * @author Patrice Blanchardie
 */
public class JAXBCreditTransferV12 implements CreditTransferOperation {
    ...
    private final CustomerCreditTransferInitiationV12 customerCreditTransferInitiation;
     ...
     */
    public JAXBCreditTransferV12(Priority instructionPriority,
    ...
    public JAXBElement<Document> createDocument() {
        ...
        return new JAXBElement<>(
                new QName("urn:iso:std:iso:20022:tech:xsd:pain.001.001.12", "Document"),
                Document.class,
                document);
    }

    private CustomerCreditTransferInitiationV12 build() {

        CustomerCreditTransferInitiationV12 cti = new CustomerCreditTransferInitiationV12();

        cti.setGrpHdr(header());

        PaymentInstruction44 paymentInstructionInformationSCT3 = new PaymentInstruction44();
    ...
    private GroupHeader114 header() {
        GroupHeader114 head = new GroupHeader114();
        head.setMsgId(id);
    ...
    private CreditTransferTransaction61 transaction(Transaction transaction) {
        ...
        // transaction
        CreditTransferTransaction61 creditTransferTransactionInformation = new CreditTransferTransaction61();
    ...
    private Optional<BranchAndFinancialInstitutionIdentification8> optionalBranchAndFinancialInstitutionIdentificationOpt(BankAccount bankAccount) {
        return bankAccount.getBic().map(bic -> {
            BicUtil.validate(bic);
            FinancialInstitutionIdentification23 financialInstitutionIdentification = new FinancialInstitutionIdentification23();
            financialInstitutionIdentification.setBICFI(bic);
            BranchAndFinancialInstitutionIdentification8 branchAndFinancialInstitutionIdentification = new BranchAndFinancialInstitutionIdentification8();
    ...
    private BranchAndFinancialInstitutionIdentification8 mandatoryBranchAndFinancialInstitutionIdentification(BankAccount bankAccount) {
        BranchAndFinancialInstitutionIdentification8 branchAndFinancialInstitutionIdentification = new BranchAndFinancialInstitutionIdentification8();
        FinancialInstitutionIdentification23 financialInstitutionIdentification = new FinancialInstitutionIdentification23();
    ...
    private PartyIdentification272 partyIdentification(Party party) {
        PartyIdentification272 partyIdentification = new PartyIdentification272();
        if (party != null) {
    ...
    private PostalAddress27 postalAddress(PostalAddress postalAddress) {
        PostalAddress27 postalAddress24 = new PostalAddress27();
    ...
    private CashAccount40 cashAccount(BankAccount bankAccount) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof JAXBCreditTransferV12)) return false;
        JAXBCreditTransferV12 that = (JAXBCreditTransferV12) o;
    ...
    public String toString() {
        return new StringJoiner(", ", JAXBCreditTransferV12.class.getSimpleName() + "[", "]")
